...
urlpatterns = [
    ...
    path('today-reminders/',                 today_reminders ,  name='today_reminders'),
    path('tomorrow-reminders/',              tomorrow_reminders,name='tomorrow_reminders'),
